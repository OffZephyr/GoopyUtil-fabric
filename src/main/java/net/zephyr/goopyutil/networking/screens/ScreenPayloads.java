package net.zephyr.goopyutil.networking.screens;
...
public class ScreenPayloads {
    public static final Identifier SetBlockScreen = Identifier.of(GoopyUtil.MOD_ID, "s2c_block_screen_open");
    public static final Identifier SetEntityScreen = Identifier.of(GoopyUtil.MOD_ID, "s2c_entity_screen_open");
    public static final Identifier SetItemScreen = Identifier.of(GoopyUtil.MOD_ID, "s2c_item_screen_open");
    public static final Identifier SetNbtScreen = Identifier.of(GoopyUtil.MOD_ID, "s2c_nbt_screen_open");
    public static final Identifier SetScreen = Identifier.of(GoopyUtil.MOD_ID, "s2c_screen_open");
