...
public class COMPCodeScreen extends COMPBaseAppScreen {
    ...
    int maxSubScroll = 0;
    Identifier BASE = Identifier.of(GoopyUtil.MOD_ID, "textures/gui/computer/code_window.png");
    Identifier LIST = Identifier.of(GoopyUtil.MOD_ID, "textures/gui/computer/computer_list.png");
    Identifier BUTTONS = Identifier.of(GoopyUtil.MOD_ID, "textures/gui/computer/computer_buttons.png");
    ...
    void drawBehaviorSelection(DrawContext context, int mouseX, int mouseY){
        ...
        Text behaviorName = ComputerData.getAIBehavior(this.currentBehavior) instanceof ComputerAI ai ? ai.getName() : Text.translatable("goopyutil.screens.computer_code.no_behavior");
    ...
    void drawTextEdit(DrawContext context){
        if(this.subWindow == BEHAVIOR_TEXT_EDIT){
            ...
            drawResizableText(context, textRenderer, Text.translatable("goopyutil.screens.computer_code.edit_number"), 1.5f, this.width /2f, this.height /2f - 10, 0xFFFFFFFF, 0x00000000, false, true);
            drawResizableText(context, textRenderer, Text.translatable("goopyutil.screens.computer_code.edit_number.esc"), 0.85f, topCornerX + 3, topCornerY + 3, 0xFFFFFFFF, 0x00000000, false, false);
            drawResizableText(context, textRenderer, Text.translatable("goopyutil.screens.computer_code.edit_number.ent"), 0.85f, topCornerX + 3, topCornerY + 15, 0xFFFFFFFF, 0x00000000, false, false);
    ...
    void drawEntitySelection(DrawContext context, int mouseX, int mouseY){
        ...
        Text entityName = this.entity instanceof LivingEntity ? this.entity.getName() : Text.translatable("goopyutil.screens.computer_code.no_entity");
