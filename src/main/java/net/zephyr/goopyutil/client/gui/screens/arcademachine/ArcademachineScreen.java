package net.zephyr.goopyutil.client.gui.screens.arcademachine;
...
public class ArcademachineScreen extends GoopyScreen {
    Identifier texture = Identifier.of(GoopyUtil.MOD_ID, "textures/gui/arcademachines/floorboards.png");
    Identifier CHARACTER = Identifier.of(GoopyUtil.MOD_ID, "textures/gui/arcademachines/freddyidle.png");
    Identifier WALLS = Identifier.of(GoopyUtil.MOD_ID, "textures/gui/arcademachines/caketemp.png");
