            ...
            if (client.options.playerListKey.isPressed()) {
                ...
                if (client.player.getMainHandStack().isOf(ItemInit.TAPEMEASURE) || client.player.getMainHandStack().isOf(ItemInit.PAINTBRUSH)) {
                    ...
                    if (client.player.getMainHandStack().isOf(ItemInit.TAPEMEASURE)) {
                        Text line1 = Text.translatable("item.goopyutil.tapemeasure.map_cam.line1");
                        Text line2 = Text.translatable("item.goopyutil.tapemeasure.map_cam.line2");
                        Text line3 = Text.translatable("item.goopyutil.tapemeasure.map_cam.line3");
                        Text line4 = Text.translatable("item.goopyutil.tapemeasure.map_cam.line4");
                        ...
                        Text line2 = Text.translatable("item.goopyutil.paintbrush.map_cam.line2");
                        Text line3 = Text.translatable("item.goopyutil.paintbrush.map_cam.line3");
                        Text line4 = Text.translatable("item.goopyutil.paintbrush.map_cam.line4");
