...
import net.zephyr.goopyutil.networking.nbt_updates.UpdateBlockNbtC2SPayload;
import net.zephyr.goopyutil.networking.nbt_updates.UpdateEntityNbtC2SPayload;
import net.zephyr.goopyutil.networking.nbt_updates.UpdateItemNbtC2SPayload;
import net.zephyr.goopyutil.networking.screens.*;
